...
export const metadata: Metadata = {
  title: `Outil analytics RGPD : guide complet ${CURRENT_YEAR} — conformite CNIL`,
  description: `Guide complet sur les outils analytics conformes RGPD en ${CURRENT_YEAR}. Quels outils sont exemptes de consentement CNIL ? Alternatives a Google Analytics, bonnes pratiques et sanctions.`,
  alternates: {
    canonical: `${BASE_URL}/ressources/rgpd-analytics`,
  },
  openGraph: {
    title: `Outil analytics RGPD : guide complet ${CURRENT_YEAR}`,
    description: `Tout savoir sur la conformite RGPD des outils analytics : recommandations CNIL, outils conformes, bonnes pratiques.`,
  ...
  return (
    <article className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
            ...
            <tbody>
              {tools.map((tool) => (
                <tr key={tool.slug}>
                  ...
                  <td className="p-3 border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400">{localize(tool.compliance.dataLocation, "fr")}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <section className="mb-12">
        <FaqSection
          items={rgpdFaq}
          heading="Questions frequentes RGPD et analytics"
        />
      </section>
