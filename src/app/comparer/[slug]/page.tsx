...
import { CURRENT_YEAR, SITE_NAME, BASE_URL } from "@/lib/constants";
...
export default async function VsPage({ params }: PageProps) {
  ...
  const faqJsonLd: FAQPage = {
    ...
    mainEntity: faq.map((item) => ({
      "@type": "Question",
      name: localize(item.question, "fr"),
      acceptedAnswer: { "@type": "Answer", text: localize(item.answer, "fr") },
    })),
  };
