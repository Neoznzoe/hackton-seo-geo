...
const LEGAL_ITEMS: { key: keyof LegalPages; label: string; required: string }[] = [
  { key: "mentionsLegales", label: "Mentions legales", required: "Obligatoire (loi LCEN)" },
  { key: "politiqueConfidentialite", label: "Politique de confidentialite", required: "Obligatoire (RGPD art. 13)" },
  { key: "cgu", label: "CGU", required: "Fortement recommande" },
  { key: "cgv", label: "CGV", required: "Obligatoire (e-commerce)" },
  { key: "politiqueCookies", label: "Politique cookies", required: "Recommande" },
];
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-semibold text-gray-900">Pages legales</h3>
