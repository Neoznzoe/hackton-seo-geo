  ...
  const links = [
    {
      ...
      desc: "Trouvez l'alternative idéale",
    },
    {
    ...
    },
    {
      ...
      desc: "Tout savoir sur la conformité",
    },
    {
      href: "/#outils",
      event: "outils",
      ...
      desc: "8 solutions analysées",
    },
  ];

  return (
    <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
      <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Aller plus loin</h2>
