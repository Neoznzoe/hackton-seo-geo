  ...
  return (
    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-5 shadow-sm">
      <div className="flex items-center gap-3 mb-4">
        <div className="w-9 h-9 bg-purple-50 dark:bg-purple-950 rounded-lg flex items-center justify-center shrink-0">
      ...
      {resources.length === 0 ? (
        ...
        <div className="space-y-2.5">
          {risky.map((r) => (
            <div key={r.name} className="flex items-start gap-2 bg-red-50 dark:bg-red-950 border border-red-100 dark:border-red-800 rounded-lg p-2.5">
          ...
          {safe.map((r) => (
            <div key={r.name} className="flex items-start gap-2 bg-green-50 dark:bg-green-950 border border-green-100 dark:border-green-800 rounded-lg p-2.5">
